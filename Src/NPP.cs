...
namespace NppPIALexer2
{
    ...
    public class NPP
    {
        ...
        public static void SetupFolding() {
            ...
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_SETMARGINMASKN, 1, SciMsg.SC_MASK_FOLDERS);//margin2 set to hold folder symbols
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_SETMARGINSENSITIVEN, 1, 1); //margin2 set as sensitive to clicks
            ...
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_MARKERDEFINE, SciMsg.SC_MARKNUM_FOLDERSUB, SciMsg.SC_MARK_EMPTY);
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_MARKERDEFINE, SciMsg.SC_MARKNUM_FOLDERTAIL, SciMsg.SC_MARK_EMPTY);
            ...
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_MARKERSETBACK, SciMsg.SC_MARKNUM_FOLDERSUB, (SciMsg)Color.Black.ToArgb());
            Win32.SendMessage(PluginBase.GetCurrentScintilla(), SciMsg.SCI_MARKERSETBACK, SciMsg.SC_MARKNUM_FOLDERTAIL, (SciMsg)Color.Black.ToArgb());
        }
